...
function NewBranch({ handleSubmit, handleClose, createSWA }) {
  const classes = useStyles1();
  const classes1 = useStyles();
  const [state, setState] = React.useState({ WH: false, HO: false });
  ...
  const submit = (values) => {
    ...
    createSWA("success", {
      ...
      message: "You’ve sucessfully add a New Branch",
      time: 2000
    })
...
export default compose(connect(null, { createSWA }), reduxForm({ form: 'newBranch', destroyOnUnmount: false }))(NewBranch);
