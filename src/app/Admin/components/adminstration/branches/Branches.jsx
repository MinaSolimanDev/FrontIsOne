...
import DeleteBranch from "../../../../../common/components/modals/DeleteModal";
// Assets
...
const rows = [
  createData(1, "AG", "IS_0000015", "ALACTAGROWS1"),
  createData(2, "AG", "IS_0000016", "ALACTAGROWB2"),
  createData(3, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(4, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(5, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(6, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(7, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(8, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(9, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(10, "AG", "IS_0000017", "ALACTAGROWZ3"),
  createData(11, "AG", "IS_0000017", "ALACTAGROWZ3"),
];

function createData(id, short_description, code, description) {
  return { id, short_description, code, description };
}
...
const Branches = () => {
  ...
  const tableHead = [
    ...
    { name: "code", content: "Code", sortable: true },
  ...
  return (
    <Slide in direction="up">
      <div className={classes.adminstration}>
        ...
        />
        {/* Create New Branch */}
        {open.new && <NewBranch handleClose={() => setOpen({ new: false })} />}
        {/* Edit Existing Brand */}
        {open.edit?.state && (
          <EditBranch
        ...
        {open.delete?.state && (
          <DeleteBranch
            ...
            message="If you proceed, you will lose the data of this Branch."
