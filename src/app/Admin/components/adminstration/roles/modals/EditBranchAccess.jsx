...
function EditBranchAccess({ handleSubmit, handleClose }) {
      ...
      >
        <DialogContent>
          ...
          <div className={classes1.modal__header}>
            <div>
              <Typography style={{ fontSize: 20, lineHeight: "32px", color: primaryColor, fontWeight: "normal" }}>Edit Branch Access</Typography>
            </div>
          </div>
